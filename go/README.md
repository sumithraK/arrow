...
[![GoDoc](https://godoc.org/github.com/sumithraK/arrow/go/arrow?status.svg)](https://godoc.org/github.com/sumithraK/arrow/go/arrow)
...
goos: darwin
goarch: amd64
pkg: github.com/sumithraK/arrow/go/arrow/math
...
PASS
ok  	github.com/sumithraK/arrow/go/arrow/math	6.444s
```
...
PASS
ok  	github.com/sumithraK/arrow/go/arrow/math	4.786s
```
...
PASS
ok  	github.com/sumithraK/arrow/go/arrow/math	6.179s
```
